//
//  XYSanBidPlanDetailController.m
//  LYDApp
//
...
@interface XYSanBidPlanDetailController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation XYSanBidPlanDetailController
...
- (void)loadPlanDetailData
{
    ...
    NSDictionary *secretDict = @{@"appKey":APPKEY,@"timestamp":timestamp,@"deviceId":DEVICEID,@"token":TOKEN,@"pageIndex":[NSNumber numberWithInteger:self.planDetailPage],@"pageSize":[NSNumber numberWithInteger:10],@"bidId":self.planId};
    
    NSString *sign = [LYDTool createMD5SignWithDictionary:secretDict];
    NSDictionary *para = @{@"appKey":APPKEY,@"timestamp":timestamp,@"deviceId":DEVICEID,@"token":TOKEN,@"pageIndex":[NSNumber numberWithInteger:self.planDetailPage],@"pageSize":[NSNumber numberWithInteger:10],@"bidId":self.planId,@"sign":sign};
    
    [LYDTool sendGetWithUrl:[NSString stringWithFormat:@"%@/product/bids/%@/loans",APIPREFIX,self.planId] parameters:para success:^(id data) {
