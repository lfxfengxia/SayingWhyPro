//
//  DSYBannerDetailViewController.m
//  LYDApp
//
...
@interface DSYBannerDetailViewController ()<UIWebViewDelegate,UIViewControllerTransitioningDelegate>
@property (nonatomic, strong) UIWebView *contentWibView;
@property (nonatomic,strong) AlertFenXiangGuoDongVC *pictureVC;
@property (nonatomic,strong) AlertFenXiangGuoDongVCNew *pictureVCNew;
@property (nonatomic,strong) PictureViewCtr *pictureVCctr;
@end

@implementation DSYBannerDetailViewController
...
- (void)loadData {
   ...
   [self.contentWibView loadRequest:[NSMutableURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@?token=%@&appKey=%@",self.banner.linkUrl,TOKEN,APPKEY]]]];
}
...
-(void)GetShowData
{
    ...
    NSString *URL_strLogin=[NSString stringWithFormat:@"%@%@",APIPREFIX,@"/activity/partookSuccessCallbacksBox"];
...
//        {
//        
//            NSString      *userSubAmount=[backData objectForKey:@"message"];
//            //userSubAmount=150;
//            _pictureVC = [[PictureViewCtr alloc] initWithImageName:@"HuoDongconfigUI1" ButtonName:@"HuoDongconSurefigUI1" Amount:userSubAmount JumpBlock:^{
//                
//                
//                NSLog(@"tt11");
//                
...
//        }
        ...
        if ([msg integerValue]==1) {
            ...
            NSString      *shareAlertType=[backData objectForKey:@"shareAlertType"];
            
            if ([shareAlertType integerValue]==1) {
            ...
            else  if ([shareAlertType integerValue]==2) {
                _pictureVCNew = [[AlertFenXiangGuoDongVCNew alloc] initWithImageName:@"bgFenXianghuodong2" ButtonName:@"HuoDongconSurefigUI1" Amount:@"" JumpBlock:^{
                ...
                _pictureVCNew.transitioningDelegate = self;
                _pictureVCNew.modalPresentationStyle = UIModalPresentationCustom;
                
                [self presentViewController:_pictureVCNew animated:NO completion:nil];
            }
            else  if ([shareAlertType integerValue]==3) {
                _pictureVCNew = [[AlertFenXiangGuoDongVCNew alloc] initWithImageName:@"bgFenXianghuodong3" ButtonName:@"HuoDongconSurefigUI1" Amount:@"" JumpBlock:^{
            ...
            else
            {
                            ...
                            NSString      *userSubAmount=[backData objectForKey:@"message"];
                            //userSubAmount=150;
                            _pictureVCctr = [[PictureViewCtr alloc] initWithImageName:@"HuoDongconfigUI1" ButtonName:@"HuoDongconSurefigUI1" Amount:userSubAmount JumpBlock:^{
                            ...
                            _pictureVCctr.transitioningDelegate = self;
                            _pictureVCctr.modalPresentationStyle = UIModalPresentationCustom;
                            
                            [self presentViewController:_pictureVCctr animated:NO completion:nil];
