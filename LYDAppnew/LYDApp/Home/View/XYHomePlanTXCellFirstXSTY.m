...
@interface XYHomePlanTXCellFirstXSTY ()
...
@implementation XYHomePlanTXCellFirstXSTY

+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"XYHomePlanTXCellFirstXSTY";
    XYHomePlanTXCellFirstXSTY *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[XYHomePlanTXCellFirstXSTY alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
