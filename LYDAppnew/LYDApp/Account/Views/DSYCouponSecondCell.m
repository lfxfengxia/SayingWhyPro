...
@implementation DSYCouponSecondCell
...
+ (DSYCouponSecondCell *)cellForTableView:(UITableView *)tableView {
    static NSString *ID = @"couponSecondCell";
    DSYCouponSecondCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[DSYCouponSecondCell alloc] initWithStyle:(UITableViewCellStyleDefault) reuseIdentifier:ID];
    }
    return cell;
}
...
- (void)creatSubviews {
    ...
    [_investBtn setTitle:@"立即\n投资" forState:(UIControlStateNormal)];
