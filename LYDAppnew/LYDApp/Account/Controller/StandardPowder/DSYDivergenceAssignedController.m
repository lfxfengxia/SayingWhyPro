//
//  DSYDivergenceAssignedController.m
//  LYDApp
//
...
@interface DSYDivergenceAssignedController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) NSMutableArray *dataList;           /**< 保存数据的数据 */

@end

@implementation DSYDivergenceAssignedController
