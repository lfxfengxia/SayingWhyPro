...
- (NSDictionary *)getMyParaWithIndex:(NSInteger)pageIndex {
    ...
    NSDictionary *secretDict = @{@"appKey":APPKEY, @"timestamp":timestamp, @"deviceId":DEVICEID, @"token":TOKEN, @"pageIndex":@(pageIndex), @"pageSize":@(kDSYPageSize), @"bidsType":[NSNumber numberWithInt:[self.bidType intValue]], @"investStatus":@2, @"startDate":self.startDate, @"endDate":self.endDate};
    // 生成签名认证
    NSString *sign = [LYDTool createMD5SignWithDictionary:secretDict];
    NSDictionary *para = @{@"appKey":APPKEY, @"timestamp":timestamp, @"deviceId":DEVICEID, @"token":TOKEN, @"pageIndex":@(pageIndex), @"pageSize":@(kDSYPageSize), @"bidsType":[NSNumber numberWithInt:[self.bidType intValue]], @"investStatus":@2, @"startDate":self.startDate, @"endDate":self.endDate, @"sign":sign};
