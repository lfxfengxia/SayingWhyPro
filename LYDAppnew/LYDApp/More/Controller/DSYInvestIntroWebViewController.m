//
//  DSYInvestIntroWebViewController.m
//  LYDApp
//
...
#import "DSYInvestIntroWebViewController.h"

@interface DSYInvestIntroWebViewController ()<UIWebViewDelegate>

@property (nonatomic, strong) UIWebView *contentWibView;     /**< 主视图 */

@end

@implementation DSYInvestIntroWebViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.view.backgroundColor = RGB(255, 255, 255);
    self.navigaTitle = @"投资说明";
    [self contentWibView];
    [self loadData];
}
...
- (void)loadData {
    ...
    [LYDTool sendGetWithUrl:[NSString stringWithFormat:@"%@/help/invest", APIPREFIX] parameters:nil success:^(id data) {
