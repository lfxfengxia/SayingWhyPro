//
//  DSYDivergenceCompleteController.m
//  LYDApp
//
...
@interface DSYDivergenceCompleteController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) NSMutableArray *dataList;           /**< 保存数据的数据 */

@end

@implementation DSYDivergenceCompleteController
