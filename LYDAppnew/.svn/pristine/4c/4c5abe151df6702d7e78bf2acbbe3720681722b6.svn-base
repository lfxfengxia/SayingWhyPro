...
#define kNaviBarAndBottonBarBgColor  ([UIColor colorWithRed:0.01f green:0.67f blue:0.76f alpha:1.00f])
...
@property (nonatomic, assign)NSInteger isNeedCreatRelease;
