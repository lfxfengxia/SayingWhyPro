...
//  LYDApp
//
//  Created by fcl on 2017/4/20.
//  Copyright © 2017年 dookay_73. All rights reserved.
//

#import "ChangJianWenTiViewController.h"

@interface ChangJianWenTiViewController ()
...
- (void)loadData {
    ...
    [LYDTool sendGetWithUrl:[NSString stringWithFormat:@"%@/help/getProblemUrl?type=app", APIPREFIX] parameters:nil success:^(id data) {
