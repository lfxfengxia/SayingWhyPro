...
@implementation DSYCouponFourthCell
...
+ (DSYCouponFourthCell *)cellForTableView:(UITableView *)tableView {
    static NSString *ID = @"couponFourthCell";
    DSYCouponFourthCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[DSYCouponFourthCell alloc] initWithStyle:(UITableViewCellStyleDefault) reuseIdentifier:ID];
    }
    return cell;
}
...
- (void)creatSubviews {
    ...
    [_investBtn setTitle:@"删除" forState:(UIControlStateNormal)];
