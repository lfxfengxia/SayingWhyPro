...
//    [alert show];
    ...
    if ([self.delegate respondsToSelector:@selector(addressDoneBtnClickedWith:city:county:)]) {
        [self.delegate addressDoneBtnClickedWith:self.selectedProvince city:self.selectedCity county:self.selectedArea];
    }
