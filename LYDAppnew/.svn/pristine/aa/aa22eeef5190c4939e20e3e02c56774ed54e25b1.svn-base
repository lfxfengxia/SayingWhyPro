//
//  DSYDivergenceHoldingController.m
//  LYDApp
//
...
@interface DSYDivergenceHoldingController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) NSMutableArray *dataList;           /**< 保存数据的数据 */

@end

@implementation DSYDivergenceHoldingController
